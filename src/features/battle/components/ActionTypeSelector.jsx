  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-gray-800/80 to-gray-900/80 rounded-lg border border-white/10 p-2 shadow-lg text-white font-sans flex flex-col">
      ...
      <div className="mb-2 bg-gray-700/30 rounded-lg p-1 overflow-x-auto whitespace-nowrap">
        <div className="flex items-center">
          ...
          <div>
            ...
            <div className="text-xs text-gray-300">HP: {selectedUnit.stats.currentHp}/{selectedUnit.stats.maxHp} | MP: {selectedUnit.stats.currentMp}/{selectedUnit.stats.maxMp}</div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col gap-1 overflow-y-auto custom-scrollbar">
        <button 
          className={`px-3 py-1.5 rounded-lg font-medium text-xs transition-all duration-300 focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-offset-gray-800 shadow-sm ${selectedAction === 'attack' ? 'bg-gradient-to-r from-red-700 to-red-600 text-white ring-red-500' : 'bg-gradient-to-b from-gray-700 to-gray-800 text-gray-200 ring-gray-500'}`}
